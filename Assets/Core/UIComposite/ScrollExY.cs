    ...
    public class ScrollExY : ScrollContent
    {
        ...
        public override void Order(float os, bool force = false)
        {
            ...
            if (showpop)
            {
                ...
                PopWindow.transform.localPosition = new Vector3(0, dy, 0);
            }
        }
        bool UpdateItem(float dy, int index, bool force)
        {
            ...
            a.target.transform.localPosition = new Vector3(ox, os, 0);
        ...
        bool showpop = false;
        public void SetPopWindow(GameObject obj)
        {
            PopWindow = obj;
            PopWindow.transform.SetParent(ScrollView);
        }
